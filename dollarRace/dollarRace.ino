...
void setup() {
  ...
  }// here we start the race and move forward up until where the black swuare is
  delay(1000);
  startRace();
  startTimer();
  moveForward();
...
void moveForward() {
  analogWrite (motorPin1, 220);//205
  digitalWrite(motorPin2, LOW);
  analogWrite (motorPin3, 255);//240
  digitalWrite(motorPin4, LOW);
  pixels.clear();
...
void turnRight() {
  analogWrite (motorPin1, 135);//120
  digitalWrite(motorPin2, LOW);
  digitalWrite(motorPin3, LOW);
  analogWrite (motorPin4, 175);//160
  pixels.clear();
...
void moveRight() {
  analogWrite (motorPin1, 240);//225
  digitalWrite(motorPin2, LOW);//
  analogWrite (motorPin3, 125);//110
  digitalWrite(motorPin4, LOW);//
  pixels.clear();
  pixels.setPixelColor(2, pixels.Color(155, 255, 0)); // 
  pixels.show();
...
void moveLeft() {
  analogWrite (motorPin1, 125);//110
  digitalWrite(motorPin2, LOW);//
  analogWrite (motorPin3, 245);//230
  digitalWrite(motorPin4, LOW);//
  pixels.clear();
  pixels.setPixelColor(3, pixels.Color(155, 255, 0)); //
  pixels.show();
...
void turnAround() {
  digitalWrite(motorPin1, LOW);
  analogWrite (motorPin2, 185);//170
  analogWrite (motorPin3, 145);//130
  digitalWrite(motorPin4, LOW);
  pixels.clear();
  pixels.setPixelColor(3, pixels.Color(155, 255, 0)); //
